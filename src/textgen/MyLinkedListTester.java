...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
        ...
        try {
            shortList.add(null);
            fail("Check adding null elements");
        }
	...
	public void testSize()
	{
        ...
        assertEquals("Size: check short list size is correct ", 2, shortList.size());
        assertEquals("Size: check longer list size is correct ", 10, longerList.size());
	...
	public void testAddAtIndex()
	{
        ...
        //test case: adding out bounds
        try {
            shortList.add(5, "E");
            fail("Check adding out of bounds");
        }
        catch (IndexOutOfBoundsException e) {
        }
        
        // test the longer List
        try {
            longerList.add(-1, 0);
            fail("Check adding out of bounds");
        }
        ...
        //test case: adding at a middle index
        longerList.add(2, 10);
	...
	public void testSet()
	{
		...
		assertEquals("Set: check return is correct ", "C", shortList.set(1, "C"));
		assertEquals("Set: check value is correct ", "C", shortList.get(1));
		assertEquals("Set: check size is correct", 2, shortList.size());
		
		assertEquals("Set: check return is correct ", (Integer)8, longerList.set(2, 8));
		assertEquals("Set: check value is correct ", (Integer)8, longerList.get(2));
